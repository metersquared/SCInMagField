...
\label{H_F310D61F}
\matlabtitle{Hofstadter's butterfly}


\vspace{1em}
\matlabheading{Tight binding Hamiltonian with magnetic field}
...
\vspace{1em}
\matlabheadingtwo{Energy spectrum of normal metals in magnetic field}

\begin{par}
\begin{flushleft}
Generate data (\texttt{EN200x25.mat}) of eigenvalues across different values of magnetic field \texttt{b} in a for-loop for different Hamiltonian with \texttt{testRectangular.m}.
\end{flushleft}
\end{par}
