...
\begin{par}
\begin{flushleft}
The superconducting order parameter can be calculated with\texttt{ supercurrent(in, eigenE, eigenV)}.
\end{flushleft}
\end{par}
...
\begin{par}
\begin{flushleft}
\texttt{supercurrentCompute.m }can be used to collect the necessary data, i.e. variable after finding self-consistent SCOP and initialization parameters.
\end{flushleft}
\end{par}
...
\begin{par}
\begin{flushleft}
The free energy can be calculated with\texttt{ freeEnergyBCS(in, eigenV, eigenE)}.
\end{flushleft}
\end{par}
...
\begin{par}
\begin{flushleft}
\texttt{freeEnergyCompute.m }can be used to calculate free energies of both normal metal and SC, for comparison.
\end{flushleft}
\end{par}
